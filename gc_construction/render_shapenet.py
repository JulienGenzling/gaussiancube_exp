...
#img_follder = os.path.join(os.path.abspath(args.output_folder), synset_idx, model_identifier)
img_follder = os.path.join(os.path.abspath(args.output_folder), synset_idx)
